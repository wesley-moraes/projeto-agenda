...
Contato.prototype.valida = async function(){
    ...
    if(this.body.email && !validator.isEmail(this.body.email)) this.errors.push('e-mail invalido') //Se não for um email valido
...
Contato.prototype.cleanUp = function(){ //É pra garantir que tudo seja uma string
